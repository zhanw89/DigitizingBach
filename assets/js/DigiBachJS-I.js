...
//
    ...
    if (OnOff === "N") {
        ...
        if ($.inArray(performerName, list_of_performers) > -1) {
        } else {
    ...
    this.toolTIPS = function () {
        ...
        var dActualTempo = $('.data.' + contentPiece + '.' + contentPerformer +
            '.' + contentForm + '.' + contentChroma + '.' +
            contentKey).children('.actualData').text();
